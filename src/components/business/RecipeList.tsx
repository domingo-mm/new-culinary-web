...
import { useGetRecipesFromSearchedWordQuery } from '@/queries/useGetRecipesFromSearchedWordQuery';
...
const RecipeList: React.FC<IRecipeList> = ({
  setShowModal,
  debouncedSearchRecipe,
}) => {
  const { data: recipeData } = useGetRecipesFromSearchedWordQuery(
    debouncedSearchRecipe,
  );
